            ...
            <div class="card-body">
                <form action="{{ route('penduduk.store') }}" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input name="nik" type="text" class="form-control" id="floatingInput"
                            placeholder="Nomor Induk Kependudukan" aria-describedby="floatingInputHelp" />
                    ...
                    <div class="form-floating mb-3">
                        <input name="nama" type="text" class="form-control" id="floatingInput"
                            placeholder="Nama Lengkap" aria-describedby="floatingInputHelp" />
                    ...
                    <div class="form-floating mb-3">
                        <input name="tempat_lahir" type="text" class="form-control" id="floatingInput"
                            placeholder="Tempat Lahir" aria-describedby="floatingInputHelp" />
                    ...
                    <div class="form-floating mb-3">
                        <input name="nama_ayah" type="text" class="form-control" id="floatingInput"
                            placeholder="Nama Lengkap Ayah" aria-describedby="floatingInputHelp" />
                    ...
                    <div class="form-floating mb-3">
                        <input name="nama_ibu" type="text" class="form-control" id="floatingInput"
                            placeholder="Nama Lengkap Ibu" aria-describedby="floatingInputHelp" />
