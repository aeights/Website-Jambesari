        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">Profil Desa</h6>
                    <h1 class="mb-4">Penjelasan singkat Desa Jambesari</h1>
                    <p class="mb-4">Desa Jambesari adalah sebuah desa yang kaya akan potensi di bidang pertanian, peternakan, dan Usaha Mikro, Kecil, dan Menengah (UMKM). Desa Jambesari terdiri dari 5 dusun, yaitu</p>
                    <p class="mb-4"></p>
                    <div class="row gy-2 gx-4 mb-4">
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Dusun Gabugan</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Dusun Karangmalang</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Dusun Krajan</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Dusun Angsana</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Dusun Beddian</p>
                        </div>
                    </div>
                    <a class="btn btn-primary py-3 px-5 mt-2" href="{{ route('landing.profile') }}">Selengkapnya</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Potensi Desa Jambesari</h1>
            </div>
            <div class="row g-3">
