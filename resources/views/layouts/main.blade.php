...
<head>
    ...
    <meta content="Jambesari" name="keywords">
    <meta content="Website Desa Jambesari" name="description">
    ...
    <link href="{{ asset('template/landing/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
...
@endif
    ...
    <script src="{{ asset('template/landing/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ asset('template/landing/lib/owlcarousel/owl.carousel.min.js') }}"></script>
