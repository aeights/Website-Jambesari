...
<head>
    ...
    <title>Dashboard - Desa Jambesari</title>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('kartu-keluarga') }}" class="menu-link">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('rukun-warga') }}" class="menu-link">
                                    <div>Rukun Warga</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('rukun-tetangga') }}" class="menu-link">
                                    <div>Rukun Tetangga</div>
                                </a>
                            </li>
                            {{-- <li class="menu-item">
                                <a href="{{ route('dashboard') }}" class="menu-link">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('dashboard') }}" class="menu-link">
                                    <div>Status Hubungan Keluarga</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('dashboard') }}" class="menu-link">
                                    <div>Pendidikan Akhir</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('dashboard') }}" class="menu-link">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('dashboard') }}" class="menu-link">
                                    <div>Hubungan Kepala Keluarga</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('dashboard') }}" class="menu-link">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ asset('assets/jambesari.jpg') }}" alt
                                            class="w-px-40 w-px-40 rounded-circle" />
                                    </div>
                                </a>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <img src="{{ asset('assets/jambesari.jpg') }}"
                                                            alt class="w-px-40 w-px-40 rounded-circle" />
                                                    </div>
                                                </div>
